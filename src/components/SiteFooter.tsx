...
const footerGroups = [
  {
    ...
    links: [
      ...
      { href: "/story", label: "建築編" },
      { href: "/story", label: "土木編" },
    ],
  },
  {
    title: "会社情報",
    links: [
      { href: "/about", label: "ごあいさつ・理念" },
      { href: "/company", label: "会社概要 / 沿革" },
...
export function SiteFooter() {
  return (
    <footer className="bg-[#1f2b3a] py-12 text-[#e6e0d8]">
      ...
      <div className="mx-auto mt-10 max-w-6xl border-t border-white/20 px-4 pt-5 text-xs text-[#a59d92] md:px-8 lg:px-10">
